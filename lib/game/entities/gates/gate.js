  ...
  ig.module('game.entities.gates.gate').requires('impact.entity', 'game.entities.message').defines(function() {
    return window.EntityGate = ig.Entity.extend({
      ...
      failMessage: function() {
        ig.game.record("Gate", this.gateType, "unpassable", this.difficulty);
        return "The door won't budge./nYour powers of " + this.gateType + " are not yet strong enough.";
      },
      checkAnswer: function() {
        var correct;
        correct = this.correct_answer.toString() === this.player_answer;
        ig.game.record("Gate", this.gateType, correct ? "correct" : "wrong", this.difficulty);
        return correct;
      },
      update: function() {
        var i, _i;

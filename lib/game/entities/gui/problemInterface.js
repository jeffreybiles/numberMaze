  ...
  ig.module('game.entities.gui.problemInterface').requires('game.entities.gui.rectangle', 'game.entities.gui.centeredTextBox').defines(function() {
    return window.EntityProblemInterface = EntityRectangle.extend({
      ...
      init: function(x, y, settings) {
        var acceptButton, backButton, column, i, row, _i,
          _this = this;
        this.padding = 10;
        ...
        this.makeNumberButton(this.x + this.padding + 0 * (this.buttonWidth + 10), this.y + this.padding + 3 * (this.buttonHeight + 10), 0);
        backButton = ig.game.spawnEntity(EntityCenteredTextBox, this.x + this.padding + this.buttonWidth + 10, this.y + this.padding + 3 * (this.buttonWidth + 10), {
          width: this.buttonWidth * 2 + 10,
      ...
      backspace: function() {
        return this.playerAnswer = this.playerAnswer.slice(0, -1);
      },

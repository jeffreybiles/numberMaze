...
(function() {
  ...
  ig.module('game.main').requires('impact.game', 'impact.font', 'plugins.impact-storage', 'game.entities.utility.dashboard', 'game.entities.utility.timer', 'game.entities.player', 'game.entities.gui.rectangle', 'game.entities.gui.completedLevel', 'game.entities.gui.pauseScreen', 'game.entities.gui.startScreen', 'game.entities.gui.problemInterface', 'game.levels.intro', 'game.levels.center', 'game.levels.1', 'game.levels.2', 'game.levels.3', 'game.levels.4', 'game.levels.5', 'game.levels.6').defines(function() {
    var MyGame;
    MyGame = ig.Game.extend({
      ...
      goToCenter: function() {
        this.state = 'main';
        return this.changeLevel('Center', {
          x: 700,
          y: 700
        });
      },
      ...
      record: function(category, action, label, value) {
        var item, skill, _i, _j, _len, _len1, _ref, _ref1;
        if (label == null) {
          label = "";
        }
        if (value == null) {
        ...
        return console.log("About to track", category, action, label, value);
      },
      save: function() {

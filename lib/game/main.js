...
(function() {
  ...
  ig.module('game.main').requires('impact.game', 'impact.font', 'plugins.impact-storage', 'game.entities.dashboard', 'game.entities.player', 'game.entities.timer', 'game.entities.gui.rectangle', 'game.entities.gui.completedLevel', 'game.levels.intro', 'game.levels.center', 'game.levels.1', 'game.levels.2', 'game.levels.3').defines(function() {
    var MyGame;
    MyGame = ig.Game.extend({
      ...
      loadLevel: function(level) {
        ...
        return ig.game.spawnEntity(EntityCompletedLevel);
      },

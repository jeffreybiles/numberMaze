...
(function() {
  ...
  ig.module('game.main').requires('impact.game', 'impact.font', 'plugins.impact-storage', 'game.entities.dashboard', 'game.entities.player', 'game.entities.timer', 'game.entities.gui.rectangle', 'game.entities.gui.completedLevel', 'game.entities.gui.pauseScreen', 'game.levels.intro', 'game.levels.center', 'game.levels.1', 'game.levels.2', 'game.levels.3').defines(function() {
    var MyGame;
    MyGame = ig.Game.extend({
      ...
      draw: function() {
        ...
        if (this.state === 'problem') {
          ...
          return this.font.draw(this.gate.player_answer, x, y + 70, ig.Font.ALIGN.CENTER);
        }
      },
      ...
      togglePause: function() {
        if (this.state === 'pause') {
          this.state = 'main';
          return ig.game.getEntitiesByType(EntityPauseScreen)[0].kill();
        } else {
          this.state = 'pause';
